...
#' 
#' Get the AUC.   You can input either a truth & a prediction or the TPR & FPR values.   
#'
#' @param dataset   dataset.  
#' @param fpr_or_truth either the FPR or the truth value.  
#' @param tpr_or_pred  either the TPR or the prediction value
#' @param use_truth_and_preds Default is TRUE - expects 0s and 1s for truth and a score 
#'
